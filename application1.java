...
{ 
    ...
    tf5 = new JTextField(); 
    tf5.setBounds(250, 300, 250, 20); 

    l7 = new JLabel("Address:"); 
    l7.setBounds(50, 350, 250, 20); 

    area1 = new JTextArea(); 
    area1.setBounds(250, 350, 250, 30); 
    ...
    cb1.setBounds(250, 500, 90, 20); 

    l12 = new JLabel( 
        "Year of passing 12th"); 
    l12.setBounds(50, 550, 250, 20); 
    ...
    cb2.setBounds(250, 550, 90, 20);

    l13 = new JLabel( 
        "Points Secured in 10th:"); 
    l13.setBounds(50, 600, 250, 20); 

    tf7 = new JTextField(); 
    tf7.setBounds(250, 600, 250, 20); 

    l14 = new JLabel("Percentage in 12th:"); 
    l14.setBounds(50, 650, 250, 20); 

    tf8 = new JTextField(); 
    tf8.setBounds(250, 650, 250, 20); 
    ...
    Print.addActionListener( 
        ...
        Receipt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                area2.append("Father's Name: " + tf2.getText() + "\n"); 
                area2.append("RollNumber: " + tf3.getText() + "\n"); 
                area2.append("Email ID: " + tf4.getText() + "\n"); 
                area2.append("Contact Number: " + tf5.getText() + "\n"); 
                area2.append("Wants to take: " + cb.getSelectedItem().toString() + "\n"); 
        
                if (rb1.isSelected()) { 
                    area2.append("Wants to Join in School of Engineering and Applied Sciences\n"); 
                } 
                if (rb2.isSelected()) { 
                    area2.append("Wants to Join in School of Liberal Arts and Sciences\n"); 
                } 
                if (rb3.isSelected()) { 
                    area2.append("Wants to be a Hosteller \n"); 
                } 
                if (rb4.isSelected()) { 
                    area2.append("Wants to be a Day Scholar \n"); 
                } 
                area2.append("Had chosen: " + list1.getSelectedValue().toString() + "\n"); 
                area2.append("Had chosen: " + list2.getSelectedValue().toString() + "\n"); 
        
                int index2 = list2.getSelectedIndex(); 
                if (index2 == 0) { 
                    area2.append("Total amount to be paid is 4 Lakhs \n"); 
                } 
        
                if (index2 == 1) { 
                    area2.append("Total amount to be paid is 3.9 Lakhs \n"); 
                } 
        
                if (index2 == 2) { 
                    area2.append("Total amount to be paid is 3.8 Lakhs \n"); 
                } 
        
                if (index2 == 3) { 
                    area2.append("Total amount to be paid is 3.7 Lakhs \n"); 
                } 
        
                if (index2 == 4) { 
                    area2.append("Total amount to be paid is 2.9 Lakhs \n"); 
                }
...
public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new FeeForm());
}
}